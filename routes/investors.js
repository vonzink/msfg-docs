...
/* The earlier "generic template" investor endpoints (/for-template,
   /:id/template-fields) were removed when we pivoted to the
   per-investor pre-filled PDF flow. Investor info now travels with
   the uploaded PDF in dashboard.msfgco.com S3, not via DB hydration. */
